...
import SearchBar from "../../../Components/newTable.js/SearchBar";
import HalfDonutChart from "../../../Components/Charts/HalfDonutChart";
import { progressData } from "../../../Data/progressData";
import {  Users, ChevronDown, Filter } from 'lucide-react';

const activeStyle = 'border-b-2 border-purple-600 text-purple-600 font-semibold';
const desactiveStyle = 'border-b-2 border-transparent text-gray-500 dark:text-gray-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors';
    ...
    const Tab = ({ section }) => {
        return (
            <button
                ...
                className={`px-4 py-2 transition-all duration-200 ${getTheStyle(section)}`}
            >
                {section}
            </button>
        );
