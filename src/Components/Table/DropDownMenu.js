...
function DropDownMenu ({item,children,primaryKey}){
  ...
  const checkItem = selectedItem?.[primaryKey] === item?.[primaryKey]
    ...
    return (
        ...
        {checkItem && (
          <div className="absolute z-50 -left-32 -bottom-14 min-w-max  rounded-lg bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 shadow-lg ring-1 ring-black ring-opacity-5">
